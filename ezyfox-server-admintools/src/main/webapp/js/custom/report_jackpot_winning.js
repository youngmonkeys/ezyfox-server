window.onload = function(){
	...
	getChartJackpotWin(accessToken);
}
function getChartJackpotWin(accessToken){
	...
	$.ajax({
		type : "GET", 
		url : "api/get_chart_report_jackpot_win?accessToken="+ accessToken+"&from="+from+"&to="+to+"&room="+room,
		dataType : "json",
		async: true,
