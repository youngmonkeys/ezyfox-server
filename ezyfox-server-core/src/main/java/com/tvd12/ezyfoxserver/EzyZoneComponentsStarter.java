...
public abstract class EzyZoneComponentsStarter extends EzyLoggable implements EzyStartable {

    protected final EzyZoneSetting zoneSetting;
    protected final EzyZoneContext zoneContext;

    protected EzyZoneComponentsStarter(Builder<?, ?> builder) {
    ...
    public abstract static class Builder
        <T extends EzyZoneComponentsStarter, B extends Builder<T, B>>
