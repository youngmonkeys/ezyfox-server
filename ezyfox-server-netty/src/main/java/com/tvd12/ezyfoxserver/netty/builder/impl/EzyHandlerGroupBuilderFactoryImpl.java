...
import com.tvd12.ezyfoxserver.netty.handler.EzySimpleNettyHandlerGroup;
import com.tvd12.ezyfoxserver.netty.socket.EzySimpleWsHandlerGroup;
...
public class EzyHandlerGroupBuilderFactoryImpl implements EzyHandlerGroupBuilderFactory {
	...
	private EzyAbstractHandlerGroup.Builder newBuilderBySocketType() {
		EzyAbstractHandlerGroup.Builder builder = EzySimpleNettyHandlerGroup.builder();
