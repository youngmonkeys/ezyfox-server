...
public class EzySimpleNioUdpDataHandlerTest {
    ...
    @Test
    public void handleUdpHandshakeContentLengthLessThan11() throws Exception {
        // given
    ...
    @Test
    public void handleUdpHandshakeTokenSizeGreaterThan512() throws Exception {
        // given
        EzySimpleNioUdpDataHandler sut = new EzySimpleNioUdpDataHandler(1);
    ...
    @SuppressWarnings("rawtypes")
    @Test
    public void handleUdpHandshakeSessionIsNull() throws Exception {
        // given
        EzySimpleNioUdpDataHandler sut = new EzySimpleNioUdpDataHandler(1);
    ...
    @Test
    public void handleReceivedUdpPacketWithSessionTest() throws Exception {
        // given
        EzySimpleNioUdpDataHandler sut = new EzySimpleNioUdpDataHandler(1);
    ...
    @Test
    public void handleReceivedUdpPacketInvalidMessageTest() throws Exception {
        // given
        EzySimpleNioUdpDataHandler sut = new EzySimpleNioUdpDataHandler(1);
