...
public class EzySimpleValueTransformerPrimitiveArrayTest extends BaseTest {
	...
	public void test() {
		...
		assertEquals(transformer.convert(new char[] {1, 2, 3}, char[].class), new char[] {1, 2, 3});
		assertEquals(transformer.convert(new Integer[] {1, 2, 3}, char[].class), new char[] {1, 2, 3});
		assertEquals(transformer.convert(Lists.newArrayList(1, 2, 3), char[].class), new char[] {1, 2, 3});
		...
		assertEquals(transformer.convert(Lists.newArrayList(1, 2, 3), double[].class), new double[] {1, 2, 3});
		...
		assertEquals(transformer.convert(Lists.newArrayList(1, 2, 3), float[].class), new float[] {1, 2, 3});
		
		assertEquals(transformer.convert("1,2,3", int[].class), new int[] {1, 2, 3});
		assertEquals(transformer.convert(new int[] {1, 2, 3}, int[].class), new int[] {1, 2, 3});
		assertEquals(transformer.convert(new Integer[] {1, 2, 3}, int[].class), new int[] {1, 2, 3});
		assertEquals(transformer.convert(Lists.newArrayList(1, 2, 3), int[].class), new int[] {1, 2, 3});
		
		assertEquals(transformer.convert("1,2,3", long[].class), new long[] {1, 2, 3});
		assertEquals(transformer.convert(new long[] {1L, 2L, 3L}, long[].class), new long[] {1, 2, 3});
		assertEquals(transformer.convert(new Integer[] {1, 2, 3}, long[].class), new long[] {1, 2, 3});
		assertEquals(transformer.convert(Lists.newArrayList(1, 2, 3), long[].class), new long[] {1, 2, 3});
