...
public class EzySimpleValueTransformerWrapperArraysTest extends BaseTest {
	...
	public void test() {
		...
		assertEquals(transformer.convert("123;123", Character[][].class), new Character[][] {{'1', '2', '3'},{'1', '2', '3'}});
		assertEquals(transformer.convert(new char[][] {{1, 2, 3},{1, 2, 3}}, Character[][].class), new Character[][] {{1, 2, 3},{1, 2, 3}});
		assertEquals(transformer.convert(new Integer[][] {{1, 2, 3},{1, 2, 3}}, Character[][].class), new Character[][] {{1, 2, 3},{1, 2, 3}});
		...
		assertEquals(transformer.convert("1,2,3;1,2,3", Integer[][].class), new Integer[][] {{1, 2, 3},{1, 2, 3}});
		assertEquals(transformer.convert(new int[][] {{1, 2, 3},{1, 2, 3}}, Integer[][].class), new Integer[][] {{1, 2, 3},{1, 2, 3}});
		assertEquals(transformer.convert(new Integer[][] {{1, 2, 3},{1, 2, 3}}, Integer[][].class), new Integer[][] {{1, 2, 3},{1, 2, 3}});
		
		assertEquals(transformer.convert("1,2,3;1,2,3", Long[][].class), new Long[][] {{1L, 2L, 3L},{1L, 2L, 3L}});
		assertEquals(transformer.convert(new long[][] {{1L,2L,3L},{1L, 2L, 3L}}, Long[][].class), new Long[][] {{1L, 2L, 3L},{1L, 2L, 3L}});
		assertEquals(transformer.convert(new Integer[][] {{1, 2, 3},{1, 2, 3}}, Long[][].class), new Long[][] {{1L, 2L, 3L},{1L, 2L, 3L}});
		...
		assertEquals(transformer.convert("1,2,3;1,2,3", String[][].class), new String[][] {{"1", "2", "3"},{"1", "2", "3"}});
		assertEquals(transformer.convert(new String[][] {{"1", "2", "3"},{"1", "2", "3"}}, String[][].class), new String[][] {{"1", "2", "3"},{"1", "2", "3"}});
